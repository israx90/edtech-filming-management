    ...
    render() {
        ...
        const buildCard = (t) => {
            ...
            if (canEdit || canManage || canViewComments) {
                actionsHtml = `<div class="pt-actions" style="justify-content: space-between; align-items: flex-start;">`;
                
                // LEFT GROUP: State & Categorization
                actionsHtml += `<div style="display:flex; gap:6px; flex-wrap:wrap; flex:1; min-width:140px;">`;
                if (canManage) {
