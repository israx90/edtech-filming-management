    ...
    render() {
        ...
        for (const s of subjects) {
            ...
            html += `<div class="subject-item" data-id="${s.id}">
                ...
                <span class="subject-name">${s.name} <span class="subject-type" style="background:${tc.bg};color:${tc.color};font-size:10px;padding:2px 6px;border-radius:4px;white-space:nowrap;margin-left:8px;font-weight:600;">${typeLabel}</span></span>
                ...
                ${s.script_status ? (() => {
                    ...
                    return `<span class="subject-script" style="background:${sc.bg};color:${sc.color};font-size:10px;padding:2px 8px;border-radius:4px;font-weight:600;white-space:nowrap;">${sl}</span>`;
                })() : ''}
