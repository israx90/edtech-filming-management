...
const Calendar = {
    ...
    createDayCell(dayNum, dateStr, isOtherMonth, isToday, isWeekend) {
        ...
        if (this.HOLIDAYS[monthDay] && !isOtherMonth) {
            cell.innerHTML += `<div class="cal-holiday-label" title="${this.HOLIDAYS[monthDay]}" style="font-size: 8.5px; font-weight: 700; color: #ff5e5e; background: rgba(255, 94, 94, 0.1); padding: 2px 4px; border-radius: 3px; margin: 2px 0; text-transform: uppercase; text-align: center; line-height: 1.1; display:flex; gap:3px; align-items:center; justify-content:center;">
                ...
                <span style="overflow:hidden;text-overflow:ellipsis;white-space:nowrap;">${this.HOLIDAYS[monthDay]}</span>
            </div>`;
        }
        ...
        const maxShowPerShift = 2;

        if (morningSessions.length > 0) {
            const lbl = document.createElement('div');
            lbl.className = 'cal-shift-label';
            lbl.innerHTML = `<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align: middle; margin-right: 3px; color: #fbbf24;"><circle cx="12" cy="12" r="5"/><line x1="12" y1="1" x2="12" y2="3"/><line x1="12" y1="21" x2="12" y2="23"/><line x1="4.22" y1="4.22" x2="5.64" y2="5.64"/><line x1="18.36" y1="18.36" x2="19.78" y2="19.78"/><line x1="1" y1="12" x2="3" y2="12"/><line x1="21" y1="12" x2="23" y2="12"/><line x1="4.22" y1="19.78" x2="5.64" y2="18.36"/><line x1="18.36" y1="5.64" x2="19.78" y2="4.22"/></svg>Mañana`;
            cell.appendChild(lbl);
            morningSessions.slice(0, maxShowPerShift).forEach(s => cell.appendChild(renderSession(s)));
        }

        if (afternoonSessions.length > 0) {
            const lbl = document.createElement('div');
            lbl.className = 'cal-shift-label';
            lbl.innerHTML = `<svg width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="vertical-align: middle; margin-right: 3px; color: #f97316;"><path d="M17 18a5 5 0 0 0-10 0"></path><line x1="12" y1="2" x2="12" y2="9"></line><line x1="4.22" y1="10.22" x2="5.64" y2="11.64"></line><line x1="1" y1="18" x2="3" y2="18"></line><line x1="21" y1="18" x2="23" y2="18"></line><line x1="18.36" y1="11.64" x2="19.78" y2="10.22"></line><line x1="23" y1="22" x2="1" y2="22"></line><polyline points="8 6 12 2 16 6"></polyline></svg>Tarde`;
            cell.appendChild(lbl);
            afternoonSessions.slice(0, maxShowPerShift).forEach(s => cell.appendChild(renderSession(s)));
        }
        ...
        const hiddenSessions = Math.max(0, morningSessions.length - maxShowPerShift) + Math.max(0, afternoonSessions.length - maxShowPerShift);
        if (hiddenSessions > 0) {
            const more = document.createElement('div');
            more.className = 'cal-more';
            more.textContent = `+${hiddenSessions} más`;
